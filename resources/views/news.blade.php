    ...
    <section class="hero" id="home">
        <div class="main-content">
            ...
            <div class="main-btn">
                ...
                <a href="./sertifikat/cv/cvnadhim.pptx" class="btn btn2">Download CV</a>
            </div>
        </div>
    </section>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <article
                            ...
                            <img alt="News 1" src="{{ asset('image/webnportodesign.png') }}"
                            ...
                            <div class="p-4 sm:p-6 flex-1">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Proyek ini bertujuan untuk mengembangkan desain **UI/UX** yang modern, intuitif, dan
                                    ramah pengguna dengan fokus pada **User-Centered Design**, **Responsiveness**,
                                    **Visual Aesthetics**, dan **Seamless User Flow**. Desain ini dirancang untuk
                                    memberikan pengalaman pengguna yang efisien, menarik, dan mudah diakses di berbagai
                                    perangkat. Dengan pendekatan berbasis kebutuhan pengguna, proyek ini bertujuan
                                    menciptakan antarmuka yang tidak hanya estetis tetapi juga fungsional, memastikan
                                    navigasi yang lancar dan interaksi yang menyenangkan. 🚀

                                </p>
                                <a href="{{ asset('image/linkwebdesign1.pdf') }}"
                                    class="mt-4 inline-block rounded-lg bg-red-500 px-4 py-2 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">Lihat
                                    Selengkapnya</a>
                            </div>
                        </article>
                    </div>
                    <div class="swiper-slide">
                        <article
                            class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm flex flex-col h-full">
                            <img alt="News 1" src="{{ asset('image/webles.png') }}"
                                class="h-56 w-full object-cover" />
                            <div class="p-4 sm:p-6 flex-1">
                                <h3 class="text-lg font-medium text-gray-900">
                                    Project Membuat Website Les Private
                                </h3>
                                <p class="mt-2 text-sm text-gray-500">
                                    Proyek ini adalah website les privat berbasis HTML, CSS, dan JavaScript yang
                                    dirancang untuk mempermudah siswa dalam mencari tutor, menjadwalkan sesi les, dan
                                    mengakses materi belajar secara fleksibel. Dengan antarmuka responsif dan fitur
                                    interaktif seperti pencarian tutor, penjadwalan otomatis, serta kuis online,
                                    platform ini memberikan pengalaman belajar yang lebih efisien dan modern.
                                </p>
                                <a href="https://nadhimalim.github.io/lombainformaticweeks"
                                    class="mt-4 inline-block rounded-lg bg-red-500 px-4 py-2 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">Lihat
                                    Selengkapnya</a>
                            </div>
                        </article>
                    ...
                    <div class="swiper-slide">
                        <article
                            class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm flex flex-col h-full">
                            <img alt="News 1" src="{{ asset('image/paketkurir.png') }}"
                                class="h-56 w-full object-cover" />
                            <div class="p-4 sm:p-6 flex-1">
                                <h3 class="text-lg font-medium text-gray-900">
                                    Membuat Layanan Paket EXPRESS
                                </h3>
                                <p class="mt-2 text-sm text-gray-500">
                                    Proyek ini mengembangkan website layanan paket ekspres kurir menggunakan HTML, CSS,
                                    JavaScript, dan PHP. Website ini memungkinkan pengguna untuk memesan pengiriman,
                                    melacak status paket secara real-time, dan menghitung biaya pengiriman otomatis.
                                    Dengan desain responsif dan sistem backend yang efisien, platform ini memberikan
                                    pengalaman pengguna yang mudah dan cepat dalam mengirimkan paket.
                                </p>
                                <a href="https://nadhimalim.github.io/SicepatExpress"
                                    class="mt-4 inline-block rounded-lg bg-red-500 px-4 py-2 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">Lihat
                                    Selengkapnya</a>
                            </div>
                        </article>
                    ...
                    <div class="swiper-slide">
                        <article
                            class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm flex flex-col h-full">
                            <img alt="News 1"
                                src="{{ asset('image/webpariwisata.png') }}"
                                class="h-56 w-full object-cover" />
                            <div class="p-4 sm:p-6 flex-1">
                                <h3 class="text-lg font-medium text-gray-900">
                                    Membuat Web Pariwisata
                                </h3>
                                <p class="mt-2 text-sm text-gray-500">
                                    Website pariwisata ini menyediakan informasi lengkap tentang destinasi wisata, paket perjalanan, dan pemesanan tiket, dengan desain responsif yang memudahkan pengunjung mengaksesnya di berbagai perangkat. Dibuat menggunakan HTML, CSS, JavaScript, dan PHP, website ini dilengkapi dengan fitur slideshow gambar, daftar destinasi, pemesanan tiket, formulir kontak, serta testimoni pengunjung. Sistem pemesanan terintegrasi dengan pembayaran online, menawarkan pengalaman pengguna yang mudah dan interaktif.
                                </p>
                                <a href="https://nadhimalim.github.io/DESTINASIYKNRA"
                                    class="mt-4 inline-block rounded-lg bg-red-500 px-4 py-2 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">Lihat
                                    Selengkapnya</a>
                            </div>
                        </article>
                    ...
                    <div class="swiper-slide">
                        <article
                            ...
                            <div class="p-4 sm:p-6 flex-1">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Website ini merupakan profil pribadi pertama yang saya kembangkan, menampilkan informasi mengenai diri saya, pengalaman, dan keterampilan. Dibangun menggunakan HTML, CSS, JavaScript, dan PHP, website ini dirancang dengan tampilan yang responsif agar dapat diakses dengan nyaman di berbagai perangkat. Fitur utamanya meliputi halaman tentang saya, portofolio, dan kontak. Dengan desain yang interaktif dan navigasi yang mudah, website ini memberikan kesan profesional dan memudahkan pengunjung untuk mengenal lebih jauh mengenai saya serta proyek-proyek yang telah saya kerjakan.
                                </p>
                                <a href="https://github.com/NadhimAlim/nadhimalim"
                                    class="mt-4 inline-block rounded-lg bg-red-500 px-4 py-2 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">Lihat
                                    Selengkapnya</a>
                            </div>
                        </article>
